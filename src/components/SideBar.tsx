...
import { FaHome, FaShoppingCart, FaCalendarAlt, FaSignOutAlt, FaBars } from 'react-icons/fa';
            ...
            <nav className="flex flex-col space-y-4 mt-10">
              <Link
                ...
                className={`flex items-center p-2 rounded-md ${
                  isActive('/principal') ? 'bg-blue-100' : ''
                }`}
              >
                <FaHome
                  className={`mr-3 ${
                    isActive('/principal') ? 'text-blue-500' : 'text-gray-500'
                  }`}
                />
                <h1
              ...
              <Link
                to={'/buyslist'}
                className={`flex items-center p-2 rounded-md ${
                  isActive('/buyslist') ? 'bg-blue-100' : ''
                }`}
              >
                <FaShoppingCart
                  className={`mr-3 ${
                    isActive('/buyslist') ? 'text-blue-500' : 'text-gray-500'
                  }`}
                />
                <h1
                  className={`text-black ${
                    isActive('/buyslist') ? 'font-semibold text-blue-500' : ''
                  }`}
                >
                  Compras
                </h1>
              ...
              <Link
                to={'/reservationlist'}
                className={`flex items-center p-2 rounded-md ${
                  isActive('/reservationlist') ? 'bg-blue-100' : ''
                }`}
              >
                <FaCalendarAlt
                  className={`mr-3 ${
                    isActive('/reservationlist')
                      ? 'text-blue-500'
                      : 'text-gray-500'
                  }`}
                />
