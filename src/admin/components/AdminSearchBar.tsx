...
export const AdminSearchBar = () => {
  ...
  return (
    <div className="relative flex items-center justify-center w-full animate__animated animate__fadeIn">
      {/* Contenedor conjunto para Input y resultados */}
      <div className="w-full max-w-60 sm:max-w-xs mx-auto relative">
        <Input
          isClearable={false}
          radius="sm"
          classNames={{
