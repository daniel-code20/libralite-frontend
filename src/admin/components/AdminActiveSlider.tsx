    ...
    <div className="flex items-start justify-center mb-8 animate__animated animate__fadeIn shadow-md bg-white rounded-md overflow-hidden max-w-full">
      <div className="w-full px-4">
        ...
        <div className="relative">
          <button 
            onClick={scrollLeft} 
            className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-blue-400 hover:bg-blue-500 text-white font-bold rounded-full w-10 h-10 flex items-center justify-center z-10"
          >
            &lt;
          </button>
          ...
          <button 
            onClick={scrollRight} 
            className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-blue-400 hover:bg-blue-500 text-white font-bold rounded-full w-10 h-10 flex items-center justify-center z-10"
          >
            &gt;
          </button>
        </div>
